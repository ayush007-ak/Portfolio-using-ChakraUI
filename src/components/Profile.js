    ...
    return (
        <Flex direction={isNotSmallerScreen ? "row" : "column"} w="100%"
            ...
            <Box alignSelf="center" px="32" py="16">
                ...
                <Text fontSize="2xl" color="gray.400">Computer Science</Text>
            </Box>
            <Box alignSelf="center" px="32" py="16">
                <Text fontWeight="bold" fontSize="2xl">Learner and Developer, Believe in self-learning approach specialised in Web development.</Text>
